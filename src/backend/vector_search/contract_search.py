...
class ContractSearch:
    ...
    def search(self,
        ...
        """
        logger.info("\n" + "=" * 80)
        logger.info("SEMANTIC SEARCH (with category support)")
        logger.info("=" * 80)
        ...
        if section_categories:
            logger.info(f"Section Categories: {section_categories}")
        ...
        if matches:
            logger.info(f"Top score: {matches[0]['score']}")
            logger.info(f"Lowest score: {matches[-1]['score']}")
        logger.info("=" * 80)
    ...
    def search_multiple_contracts(self,
        ...
        """
        logger.info("\n" + "=" * 80)
        logger.info("MULTI-CONTRACT SEMANTIC SEARCH")
        logger.info("=" * 80)
        logger.info(f"Query: {query}")
        logger.info(f"User ID: {user_id}")
        logger.info(f"Project ID: {project_id}")
        ...
        if matches:
            ...
            logger.info(f"Results per contract: {contract_distribution}")
        logger.info("=" * 80)
    ...
    def smart_search(self,
        ...
        logger.info("\n" + "=" * 80)
        logger.info("SMART SEARCH WITH AUTO-CATEGORIZATION (OneClick Method)")
        logger.info("=" * 80)
        logger.info(f"Query: '{query}'")
        ...
        logger.info(f"Categories: {', '.join(categorization['categories'])}")
        logger.info(f"Is General Query: {categorization['is_general']}")
        logger.info(f"Confidence: {categorization['confidence']}")
        logger.info(f"Reasoning: {categorization.get('reasoning', '')}")
        ...
        logger.info(f"Found {len(results.matches) if hasattr(results, 'matches') else 0} matches")
