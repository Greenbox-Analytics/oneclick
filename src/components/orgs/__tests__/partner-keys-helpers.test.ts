...
import { endOfLocalDayIso, keyRows, keyStatus, tomorrowInputValue } from "@/lib/partnerKeys";
...
describe("keyRows", () => {
  ...
  const usage: PartnerKeyUsageRow[] = [
    { keyId: "staging", credits: 67, runs: 2, lastUsedAt: "2026-09-03T00:00:00+00:00" },
    { keyId: "prod", credits: 30, runs: 1, lastUsedAt: null },
  ];
